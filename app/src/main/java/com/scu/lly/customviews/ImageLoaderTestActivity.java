...
import com.scu.lly.customviews.adapter.ImageLoaderAdapter;
 ...
 */
public class ImageLoaderTestActivity extends Activity implements AbsListView.OnScrollListener{
    ...
    private void initView() {
        ...
        mAdapter = new ImageLoaderAdapter(this, urls, mImageWidth);
    ...
    private void initData() {
        ...
        int screenWidth = CommonUtils.getScreenMetrics(this).widthPixels;
        int space = (int) CommonUtils.dp2px(this, 20f);
